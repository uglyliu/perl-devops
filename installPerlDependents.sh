...
function deploy_clean(){
	rm -rf /root/perl-devops/SSH-Batch*;
	rm -rf /root/perl-devops/IPC-Run*;
	rm -rf /root/perl-devops/Set-Scala*;
	rm -rf /root/perl-devops/Net-OpenSS*;
	rm -rf /root/perl-devops/TermReadKe*;
	rm -rf /root/perl-devops/IO-Tt*;
	rm -rf /root/perl-devops/File-Whic*;
	rm -rf /root/perl-devops/File-HomeDi*;
}
function deploy(){
	deploy_clean;
